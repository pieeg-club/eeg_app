...
String _$splitIntoChannelsHash() => r'99432b2d9022ed0f90a42692ce321c3acb6cc6c6';
...
final splitIntoChannelsProvider =
    Provider<ProcessingStepRepo<List<List<int>>, List<int>>>.internal(
  splitIntoChannels,
...
typedef SplitIntoChannelsRef
    = ProviderRef<ProcessingStepRepo<List<List<int>>, List<int>>>;
